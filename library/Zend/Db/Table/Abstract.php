...
abstract class Zend_Db_Table_Abstract
{
     ...
     * @return void
     */
    final public static function setDefaultAdapter($db = null)
    {
     ...
     * @throws Zend_Db_Table_Exception
     */
    final protected static function _setupAdapter($db)
    {
        if ($db === null) {
            return null;
        }
     ...
     * @throws Zend_Db_Table_Exception
     */
    final protected static function _setupMetadataCache($metadataCache)
    {
    ...
    public function find()
    {
        ...
        foreach ($args as $keyPosition => $keyValues) {
            ...
            } elseif (count($keyValues) != $numberTerms) {
                require_once 'Zend/Db/Table/Exception.php';
